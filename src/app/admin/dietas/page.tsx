...
const fichas = [
  { id: 40120, nome: "Dieta Hipertrofia Base", aluno: "Julia Miggiorini Crespo", alunoId: 35991, kcal: 2100, status: "Ativo" },
  { id: 40085, nome: "Dieta Cutting", aluno: "Piter Moreira Violim", alunoId: 35562, kcal: 1800, status: "Ativo" },
  { id: 40012, nome: "Dieta Manutenção", aluno: "Glenda Oliveira Silva", alunoId: 35373, kcal: 1950, status: "Ativo" },
];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold text-foreground">Fichas de dieta</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-surface-light border-b border-border">
                ...
                <th className="text-left px-6 py-3 text-muted font-semibold">Aluno</th>
                <th className="text-left px-6 py-3 text-muted font-semibold">Calorias</th>
              ...
              {fichas.map((ficha) => (
                <tr key={ficha.id} className="border-b border-border last:border-0 hover:bg-surface-light transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/admin/dietas/${ficha.id}`} className="text-primary font-medium hover:underline">
                      {ficha.nome}
                    </Link>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-foreground font-medium">{ficha.kcal} kcal</td>
                  <td className="px-6 py-4">
